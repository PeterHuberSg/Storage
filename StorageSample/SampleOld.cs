...
//    /// <summary>
//    /// Sample Constructor. If isStoring is true, adds Sample to 
//    /// DL.Data.Samples and if there is a sampleMaster to sampleMaster.Samples.
//    /// </summary>
//    public Sample(
//      string text, 
//      int number, 
...
//    /// </summary>
//    private Sample(int key, CsvReader csvReader, DL dlData) {
//      Key = key;
...
//    /// </summary>
//    internal static Sample Create(int key, CsvReader csvReader, DL dlData) {
//      return new Sample(key, csvReader, dlData);
//    }


//    /// <summary>
//    /// Verifies that sample.SampleMaster is valid
//    /// </summary>
...
//    /// </summary>
//    internal static void Update(Sample sample, CsvReader csvReader, DL dlData) {
