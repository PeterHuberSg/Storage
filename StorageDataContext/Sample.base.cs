  ...
  public class SampleWriter: IDisposable {
      ...
      string? optional)
    {
      ...
      if (oneMasterKey is null) {
        ...
        if (oneMasterKey<0) throw new Exception($"Cannot write sample to CSV File, because OneMaster is not stored in DC.Data.SampleMasters.");
      ...
      if (otherMasterKey is null) {
        ...
        if (otherMasterKey<0) throw new Exception($"Cannot write sample to CSV File, because OtherMaster is not stored in DC.Data.SampleMasters.");
