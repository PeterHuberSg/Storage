...
namespace StorageDataContext  {
  ...
  public partial class ChildrenList_CreateOnlyParentReadonly: IStorageItemGeneric<ChildrenList_CreateOnlyParentReadonly> {
    ...
    /// <summary>
    /// Called after ChildrenList_CreateOnlyParentReadonly.Store() is executed
    /// </summary>
    ...
    /// <summary>
    /// Called before ChildrenList_CreateOnlyParentReadonly gets written to a CSV file
    /// </summary>
    ...
    /// <summary>
    /// Called after 'new ChildrenList_CreateOnlyParentReadonly()' transaction is rolled back
    /// </summary>
    ...
    /// <summary>
    /// Called after ChildrenList_CreateOnlyParentReadonly.Store() transaction is rolled back
    /// </summary>
