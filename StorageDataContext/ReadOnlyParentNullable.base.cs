...
namespace StorageModel  {
  ...
  public partial class ReadOnlyParentNullable: IStorage<ReadOnlyParentNullable> {
    ...
    /// <summary>
    /// Unique identifier for ReadOnlyParentNullable. Gets set once ReadOnlyParentNullable gets added to DC.Data.
    /// </summary>
...
#pragma warning restore 67
    ...
    /// <summary>
    /// ReadOnlyParentNullable Constructor. If isStoring is true, adds ReadOnlyParentNullable to DC.Data.ReadOnlyParentNullables.
    /// </summary>
    ...
    /// </summary>
    private ReadOnlyParentNullable(int key, CsvReader csvReader, DC context) {
      Key = key;
    ...
    /// </summary>
    internal static ReadOnlyParentNullable Create(int key, CsvReader csvReader, DC context) {
    ...
    /// <summary>
    /// Adds ReadOnlyParentNullable to DC.Data.ReadOnlyParentNullables. 
    /// </summary>
    public void Store() {
      if (Key>=0) {
        throw new Exception($"ReadOnlyParentNullable can not be stored again in DC.Data, key is {Key} greater equal 0." + Environment.NewLine + ToString());
      }
      onStore();
      DC.Data.ReadOnlyParentNullables.Add(this);
    }
    ...
    /// <summary>
    /// Removing ReadOnlyParentNullable from DC.Data.ReadOnlyParentNullables is not supported.
    /// </summary>
    public void Remove() {
