...
#pragma warning restore 67
    ...
    /// </summary>
    private LookupParent(int key, CsvReader csvReader, DC context) {
      Key = key;
    ...
    /// </summary>
    internal static LookupParent Create(int key, CsvReader csvReader, DC context) {
    ...
    /// <summary>
    /// Adds LookupParent to DC.Data.LookupParents. 
    /// </summary>
    public void Store() {
      if (Key>=0) {
        throw new Exception($"LookupParent can not be stored again in DC.Data, key is {Key} greater equal 0." + Environment.NewLine + ToString());
      }
      onStore();
      DC.Data.LookupParents.Add(this);
    }
    ...
    /// <summary>
    /// Removing LookupParent from DC.Data.LookupParents is not supported.
    /// </summary>
    public void Remove() {
