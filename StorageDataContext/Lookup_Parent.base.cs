...
#pragma warning restore 67
  ...
  /// <summary>
  /// Writes a CSV file containing records which can be read back as Lookup_Parent. Note that the keys of linked objects
  /// need to be provided in Write(), since the data context will not be involved.
  /// </summary>
  public class Lookup_ParentWriter: IDisposable {
    ...
    /// <summary>
    /// Constructor, will write the Lookup_Parent header line into the CSV file. Dispose Lookup_ParentWriter once done.
    /// </summary>
    public Lookup_ParentWriter(string? fileNamePath, CsvConfig csvConfig, int maxLineCharLenght) {
      this.csvConfig = csvConfig;
      csvWriter = new CsvWriter(fileNamePath, csvConfig, maxLineCharLenght, null, 0);
      var csvHeaderString = Csv.ToCsvHeaderString(Lookup_Parent.Headers, csvConfig.Delimiter);
      csvWriter.WriteLine(csvHeaderString);
    }


    /// <summary>
    /// Writes the details of one Lookup_Parent to the CSV file
    /// </summary>
    ...
    /// <summary>
    /// Executes disposal of Lookup_ParentWriter exactly once.
    /// </summary>
    public void Dispose() {
      Dispose(true);
    ...
    /// <summary>
    /// Is Lookup_ParentWriter already exposed ?
    /// </summary>
