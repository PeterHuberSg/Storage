...
namespace StorageModel  {
  ...
  public partial class ReadOnlyParent: IStorage<ReadOnlyParent> {
    ...
    /// <summary>
    /// Unique identifier for ReadOnlyParent. Gets set once ReadOnlyParent gets added to DC.Data.
    /// </summary>
...
#pragma warning restore 67
    ...
    /// <summary>
    /// ReadOnlyParent Constructor. If isStoring is true, adds ReadOnlyParent to DC.Data.ReadOnlyParents.
    /// </summary>
    ...
    /// </summary>
    private ReadOnlyParent(int key, CsvReader csvReader, DC context) {
      Key = key;
    ...
    /// </summary>
    internal static ReadOnlyParent Create(int key, CsvReader csvReader, DC context) {
    ...
    /// <summary>
    /// Adds ReadOnlyParent to DC.Data.ReadOnlyParents. 
    /// </summary>
    public void Store() {
      if (Key>=0) {
        throw new Exception($"ReadOnlyParent can not be stored again in DC.Data, key is {Key} greater equal 0." + Environment.NewLine + ToString());
      }
      onStore();
      DC.Data.ReadOnlyParents.Add(this);
    }
    ...
    /// <summary>
    /// Removing ReadOnlyParent from DC.Data.ReadOnlyParents is not supported.
    /// </summary>
    public void Remove() {
