...
namespace StorageModel  {
  ...
  public partial class ReadOnlyParent2: IStorage<ReadOnlyParent2> {
    ...
    /// <summary>
    /// Unique identifier for ReadOnlyParent2. Gets set once ReadOnlyParent2 gets added to DC.Data.
    /// </summary>
...
#pragma warning restore 67
    ...
    /// <summary>
    /// ReadOnlyParent2 Constructor. If isStoring is true, adds ReadOnlyParent2 to DC.Data.ReadOnlyParent2s.
    /// </summary>
    ...
    /// </summary>
    private ReadOnlyParent2(int key, CsvReader csvReader, DC context) {
      Key = key;
    ...
    /// </summary>
    internal static ReadOnlyParent2 Create(int key, CsvReader csvReader, DC context) {
    ...
    /// <summary>
    /// Adds ReadOnlyParent2 to DC.Data.ReadOnlyParent2s. 
    /// </summary>
    public void Store() {
      if (Key>=0) {
        throw new Exception($"ReadOnlyParent2 can not be stored again in DC.Data, key is {Key} greater equal 0." + Environment.NewLine + ToString());
      }
      onStore();
      DC.Data.ReadOnlyParent2s.Add(this);
    }
    ...
    /// <summary>
    /// Removing ReadOnlyParent2 from DC.Data.ReadOnlyParent2s is not supported.
    /// </summary>
    public void Remove() {
