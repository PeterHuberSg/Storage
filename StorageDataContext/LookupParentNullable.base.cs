...
namespace StorageModel  {
  ...
  public partial class LookupParentNullable: IStorage<LookupParentNullable> {
    ...
    /// <summary>
    /// Unique identifier for LookupParentNullable. Gets set once LookupParentNullable gets added to DC.Data.
    /// </summary>
...
#pragma warning restore 67
    ...
    /// <summary>
    /// LookupParentNullable Constructor. If isStoring is true, adds LookupParentNullable to DC.Data.LookupParentNullables.
    /// </summary>
    ...
    /// </summary>
    private LookupParentNullable(int key, CsvReader csvReader, DC context) {
      Key = key;
    ...
    /// </summary>
    internal static LookupParentNullable Create(int key, CsvReader csvReader, DC context) {
    ...
    /// <summary>
    /// Adds LookupParentNullable to DC.Data.LookupParentNullables. 
    /// </summary>
    public void Store() {
      if (Key>=0) {
        throw new Exception($"LookupParentNullable can not be stored again in DC.Data, key is {Key} greater equal 0." + Environment.NewLine + ToString());
      }
      onStore();
      DC.Data.LookupParentNullables.Add(this);
    }
    ...
    /// <summary>
    /// Removes LookupParentNullable from DC.Data.LookupParentNullables.
    /// </summary>
    public void Remove() {
      if (Key<0) {
        throw new Exception($"LookupParentNullable.Remove(): LookupParentNullable 'Class LookupParentNullable' is not stored in DC.Data, key is {Key}.");
      }
      onRemove();
      DC.Data.LookupParentNullables.Remove(Key);
    }
