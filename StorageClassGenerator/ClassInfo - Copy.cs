//This version has still original code, although commented out, where removing parent also removed the children
//
//actual version:
//removing a child removes it from all parents
//removing a parent is only possible once it has no more children
