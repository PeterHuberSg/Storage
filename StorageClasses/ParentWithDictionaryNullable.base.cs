...
namespace StorageModel  {
  ...
  public partial class ParentWithDictionaryNullable: IStorage<ParentWithDictionaryNullable> {
    ...
    /// <summary>
    /// Unique identifier for ParentWithDictionaryNullable. Gets set once ParentWithDictionaryNullable gets added to DL.Data.
    /// </summary>
    ...
    /// <summary>
    /// Content of ParentWithDictionaryNullable has changed. Gets only raised for changes occurring after loading DL.Data with previously stored data.
    /// </summary>
    ...
    /// <summary>
    /// ParentWithDictionaryNullable Constructor. If isStoring is true, adds ParentWithDictionaryNullable to DL.Data.ParentsWithDictionaryNullable.
    /// </summary>
    ...
    /// </summary>
    private ParentWithDictionaryNullable(int key, CsvReader csvReader, DL context) {
      Key = key;
    ...
    /// </summary>
    internal static ParentWithDictionaryNullable Create(int key, CsvReader csvReader, DL context) {
    ...
    /// <summary>
    /// Adds ParentWithDictionaryNullable to DL.Data.ParentsWithDictionaryNullable. 
    /// </summary>
    public void Store() {
      if (Key>=0) {
        throw new Exception($"ParentWithDictionaryNullable can not be stored again in DL.Data, key is {Key} greater equal 0." + Environment.NewLine + ToString());
      }
      onStore();
      DL.Data.ParentsWithDictionaryNullable.Add(this);
    }
    ...
    /// </summary>
    internal static void Update(ParentWithDictionaryNullable parentWithDictionaryNullable, CsvReader csvReader, DL _) {
    ...
    /// <summary>
    /// Removes ParentWithDictionaryNullable from DL.Data.ParentsWithDictionaryNullable and 
    /// disconnects DictionaryChild.ParentWithDictionaryNullable from DictionaryChildren.
    /// </summary>
    public void Remove() {
      if (Key<0) {
        throw new Exception($"ParentWithDictionaryNullable.Remove(): ParentWithDictionaryNullable 'Class ParentWithDictionaryNullable' is not stored in DL.Data, key is {Key}.");
      }
      onRemove();
      DL.Data.ParentsWithDictionaryNullable.Remove(Key);
    }
