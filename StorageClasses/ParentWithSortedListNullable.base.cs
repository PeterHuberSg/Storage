...
namespace StorageModel  {
  ...
  public partial class ParentWithSortedListNullable: IStorage<ParentWithSortedListNullable> {
    ...
    /// <summary>
    /// Unique identifier for ParentWithSortedListNullable. Gets set once ParentWithSortedListNullable gets added to DL.Data.
    /// </summary>
    ...
    /// <summary>
    /// Content of ParentWithSortedListNullable has changed. Gets only raised for changes occurring after loading DL.Data with previously stored data.
    /// </summary>
    ...
    /// <summary>
    /// ParentWithSortedListNullable Constructor. If isStoring is true, adds ParentWithSortedListNullable to DL.Data.ParentsWithSortedListNullable.
    /// </summary>
    ...
    /// </summary>
    private ParentWithSortedListNullable(int key, CsvReader csvReader, DL context) {
      Key = key;
    ...
    /// </summary>
    internal static ParentWithSortedListNullable Create(int key, CsvReader csvReader, DL context) {
    ...
    /// <summary>
    /// Adds ParentWithSortedListNullable to DL.Data.ParentsWithSortedListNullable. 
    /// </summary>
    public void Store() {
      if (Key>=0) {
        throw new Exception($"ParentWithSortedListNullable can not be stored again in DL.Data, key is {Key} greater equal 0." + Environment.NewLine + ToString());
      }
      onStore();
      DL.Data.ParentsWithSortedListNullable.Add(this);
    }
    ...
    /// </summary>
    internal static void Update(ParentWithSortedListNullable parentWithSortedListNullable, CsvReader csvReader, DL _) {
    ...
    /// <summary>
    /// Removes ParentWithSortedListNullable from DL.Data.ParentsWithSortedListNullable and 
    /// disconnects SortedListChild.ParentWithSortedListNullable from SortedListChildren.
    /// </summary>
    public void Remove() {
      if (Key<0) {
        throw new Exception($"ParentWithSortedListNullable.Remove(): ParentWithSortedListNullable 'Class ParentWithSortedListNullable' is not stored in DL.Data, key is {Key}.");
      }
      onRemove();
      DL.Data.ParentsWithSortedListNullable.Remove(Key);
    }
