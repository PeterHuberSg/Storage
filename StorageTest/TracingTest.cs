  ...
  public class TracingTest {
    ...
    public void TestTracing() {
      ...
      using (new DC(csvConfig)) {
        ...
        var c1 = new ChildrenList_Child("C1", p2, pn2, pc2, pcn2, isStoring: false);
        ...
        var c0 = new ChildrenList_Child("C0", p0, pn0, pc0, pcn0);
        ...
        eTM.Enqueue("Stored ChildrenList_Child # @0");
        trace("var c0 = new ChildrenList_Child(\"C0\", p0, pn0, pc0, pcn0);");
        c0 = new ChildrenList_Child("C0", p0, pn0, pc0, pcn0);
